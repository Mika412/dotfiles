...
# rofi_command="rofi -width 10 -hide-scrollbar -theme dmenu_custom"
rofi_command="rofi -width 10 -hide-scrollbar -theme dmenu_custom -bg #586e75 -opacity 100 -padding 5"
